...
Contributor grants Maintainer a perpetual, worldwide, non-exclusive,
...
where such license applies only to patent claims licensable by Contributor
that are necessarily infringed by the Contribution alone.

## 4. Representation

Contributor represents that:

- Each Contribution is Contributor's original work.
- Contributor has the legal right to grant the licenses above.
- The Contribution does not infringe any third party's copyright, patent,
  trademark, trade secret, or other rights.
- The Contribution does not contain any personal data, confidential
  information, or proprietary data of any third party.
...
Contributions are provided "as is", without warranty of any kind. Contributor
is not liable for any damages arising from the use of the Contribution.

---

By submitting a pull request, issue, or any other contribution to the
Project, Contributor acknowledges that they have read and agreed to this
